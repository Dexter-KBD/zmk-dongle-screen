...
lv_obj_t *zmk_display_status_screen()
{
    ...
    lv_obj_align(zmk_widget_wpm_status_obj(&wpm_status_widget), LV_ALIGN_TOP_LEFT, 20, 40);
#endif
    ...
    lv_obj_align(zmk_widget_signal_status_obj(&signal_status_widget), LV_ALIGN_TOP_LEFT, 20, 20);
#endif
